...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="takeabreak.css">
...
<body>
    ...
    <div class="navbar" float:right>
        ...
        <a href="AboutPagedLogged.php">ABOUT</a>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a style="background-color: #9ed9ccff ;" href=" Takeabreaklogged.php ">TAKE A BREAK</a>
    ...
    <center>
        <div class="column">
            <div class="selectdiv ">
                <label>
                    <select id="dlist" onChange="swapImage()">
                        ...
                        <option id="3" value="Images/How are you doing.png">I can't concentrate on my studies</option>
                    </select>
                </label>
            </div>
            ...
            <video width="400" height="320" controls>
                <source  id="videoToSwap" src="Videos/Focus Meditation.mp4" type="video/mp4">
            </video>
        </div>
    </center>
